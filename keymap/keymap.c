...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_HAZE] = LAYOUT(
			KC_F,    KC_V,    KC_L,    KC_Y,    L0CK,                      L0CK,    KC_G,    KC_P,    KC_A,    KC_U,
			KC_C,    KC_T,    KC_R,    KC_E,    KC_Q,                      KC_J,    KC_S,    KC_N,    KC_O,    KC_I,
			KC_B,    KC_M,    KC_H,    KC_W,    LANG1,   _______, _______, LANG2,   KC_D,    KC_K,    KC_Z,    KC_X,
	...
	[_RAISE] = LAYOUT(
			...
			KC_LT,   KC_SLSH, KC_MINS, KC_GT,   KC_EXLM, _______, _______, KC_QUES, KC_EQL,  KC_PLUS, KC_ASTR, KC_TAB,
...
const uint16_t PROGMEM bsls_combo[] = {KC_SLSH, KC_MINS, COMBO_END};
...
const uint16_t PROGMEM tild_combo[] = {KC_PLUS, KC_ASTR, COMBO_END};
