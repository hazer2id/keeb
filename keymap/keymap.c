...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	/*
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 * |  U  |  A  |  M  |  G  | l0ck| l0ck|  W  |  H  |  V  |  F  |
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 * |  I  |  O  |  N  |  S  |  J  |  Q  |  E  |  R  |  T  |  C  |
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 * |  Z  |  X  |  K  |  D  |lang1|lang2|  Y  |  L  |  B  |  P  |
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 * | cmd | ctl | alt | bspc|sp/lo| rai | sft | alt | ctl | cmd |
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 */
	[_HAZE] = LAYOUT(
			KC_U,    KC_A,    KC_M,    KC_G,    L0CK,                      L0CK,    KC_W,    KC_H,    KC_V,    KC_F,
			KC_I,    KC_O,    KC_N,    KC_S,    KC_J,                      KC_Q,    KC_E,    KC_R,    KC_T,    KC_C,
			KC_Z,    KC_X,    KC_K,    KC_D,    LANG1,   _______, _______, LANG2,   KC_Y,    KC_L,    KC_B,    KC_P,
	...
	[_QWERTY] = LAYOUT(
			...
			KC_Z,    KC_X,    KC_C,    KC_V,    LANG1,   _______, _______, LANG2,   KC_B,    KC_N,    KC_M,    XXXXXXX,
	...
	[_LOWER] = LAYOUT(
			...
			KC_TAB,  KC_INS,  TMUX,    KC_CAPS, _______, _______, _______, KC_EQL,  KC_1,    KC_2,    KC_3,    KC_0,
	...
	[_RAISE] = LAYOUT(
			...
			KC_LT,   KC_PLUS, KC_MINS, KC_GT,   KC_EXLM, _______, _______, KC_QUES, KC_EQL,  KC_SLSH, KC_ASTR, KC_TAB, 
			_______, _______, _______, KC_DEL,  ESCADJ,  _______, _______, _______, _______, _______, _______, _______
			),

	/*
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 * |recm2|recm1|  m2 |  m1 |     | f15 | f7  | f8  | f9  | f12 |
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 * |  << | vold| volu|  >> |     | f14 | f4  | f5  | f6  | f11 |
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 * | stpm| brid| briu| play|     | f13 | f1  | f2  | f3  | f10 |
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 * |     |     |     |     |     |     |     |     |     |     |
	 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	 */
